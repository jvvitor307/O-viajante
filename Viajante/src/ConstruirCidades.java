public class ConstruirCidades {
    ...
    Cidade KingdomofKalb = new Cidade("Kingdom of Kalb", 2, missao.um );
    Cidade AymarLeague = new Cidade("Aymar League", 1, null);
    Cidade Defalsia = new Cidade("Defalsia", -3, missao.dois);
    Cidade VuneseofEmpire = new Cidade("Vunese of Empire", 0, missao.tres);
